"""Generate lib/phase3OptimismIndexData.ts with full 7-language localeMap() content."""
...
def _load_translations():
    spec = importlib.util.spec_from_file_location(
        "optimism_index_translations",
        Path(__file__).resolve().parent / "build_phase3_optimism_index_translations.py",
    )
...
def main() -> None:
    ...
    out = Path(__file__).resolve().parents[1] / "lib" / "phase3OptimismIndexData.ts"
