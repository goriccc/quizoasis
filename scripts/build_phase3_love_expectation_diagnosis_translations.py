"""Translation data for phase3 love expectation diagnosis test (imported by build script)."""
...
_gen_path = Path(__file__).resolve().parent / "gen_phase3_love_expectation_diagnosis_data.py"
...
def _ko_r(type_idx: int, field: str) -> str:
    key_map = {
        "title": "title_ko",
        "expectationSummary": "expectation_summary",
        "quote": "quote",
        "description": "description",
        "expectationType": "expectation_type",
        "expectationKeywords": "expectation_keywords",
        "strengths": "strengths",
        "cautions": "cautions",
        "guidanceAdvice": "guidance_advice",
...
def _load_questions_i18n() -> list[dict]:
    data = json.loads((_I18N_DIR / "_love_i18n_payload.json").read_text(encoding="utf-8"))
    return data["questions"]


def _load_results_i18n() -> list[dict[str, dict[str, str]]]:
    return json.loads((_I18N_DIR / "_love_i18n_results.json").read_text(encoding="utf-8"))


_Q_I18N = _load_questions_i18n()
_R_I18N = _load_results_i18n()

_TYPE_META = [("Type1", "🌿"), ("Type2", "🌱"), ("Type3", "⚖️"), ("Type4", "💙"), ("Type5", "🌟"), ("Type6", "❤️")]
_RESULT_FIELDS = [
    "title",
    "expectationSummary",
    "quote",
