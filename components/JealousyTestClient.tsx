...
import { JealousyQuestion, JealousyResult } from '@/lib/jealousyData';
...
export default function JealousyTestClient({ 
  ...
  const handleShareResult = async () => {
    ...
    const shareText = t('jealousyTest.shareMessages.default', { type: resultTitle }) + `\n\n${`https://myquizoasis.com${window.location.pathname}`}`;
    ...
    if (navigator.share) {
      ...
      try {
        ...
        alert(t('jealousyTest.alerts.resultCopied'));
      } catch (error) {
        console.error('클립보드 복사 실패:', error);
        alert(t('jealousyTest.alerts.shareFailed'));
      }
    }
  };
  ...
  const shareToWeChat = async () => {
    ...
    const shareText = result 
      ? t('jealousyTest.shareMessages.wechat', { type: resultTitle }) + `\n\n${url}`
      : `${title}\n\n${url}`;
    ...
    try {
      ...
      alert(t('jealousyTest.alerts.wechatCopy'));
    } catch (error) {
      alert(t('jealousyTest.alerts.shareFailed'));
    }
  };
  ...
  const shareToWhatsApp = () => {
    ...
    const resultTitle = result ? (result.title[locale as keyof typeof result.title] || result.title.ko) : '';
    const shareText = result 
      ? encodeURIComponent(t('jealousyTest.shareMessages.whatsapp', { type: resultTitle }))
  ...
  const shareToKakao = () => {
    ...
    if (!window.Kakao || !window.Kakao.isInitialized()) {
      alert(t('jealousyTest.alerts.kakaoInit'));
      return;
    }
    ...
    const shareDescription = result 
      ? t('jealousyTest.shareMessages.kakao', { type: resultTitle })
      : description;
    ...
    try {
      ...
      alert(t('jealousyTest.alerts.kakaoError'));
    }
  };
  ...
  const shareToTelegram = () => {
    ...
    const resultTitle = result ? (result.title[locale as keyof typeof result.title] || result.title.ko) : '';
    const shareText = result 
      ? t('jealousyTest.shareMessages.telegram', { type: resultTitle })
      : title;
  ...
  const copyLink = () => {
    ...
    alert(t('jealousyTest.alerts.linkCopied'));
  };
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="relative w-full overflow-hidden mb-3" style={{ aspectRatio: '680/384' }}>
            <Image
              src={getThumbnailUrl(thumbnail || 'test_233_jealousy_level.jpg')}
              alt={title}
              fill
          ...
          <div className="px-4">
            ...
            <div className="text-gray-600 mb-6 leading-relaxed text-center space-y-3">
              <p className="font-bold text-gray-700">{t('jealousyTest.startMessage.line1')}</p>
              <p>{t('jealousyTest.startMessage.line2')}</p>
              <p>{t('jealousyTest.startMessage.line3')}</p>
              <p>{t('jealousyTest.startMessage.line4')}</p>
              <p>{t('jealousyTest.startMessage.line5')}</p>
              <p className="whitespace-pre-line">{t('jealousyTest.startMessage.line6')}</p>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          <div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {resultPros.length > 0 ? (
                    ...
                    <span className="text-gray-500 text-sm">{t('jealousyTest.ui.noData')}</span>
                  )}
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              ...
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-3">
                  💚 {t('jealousyTest.ui.compatibleTypes')}
                </h3>
              ...
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-3">
                  ⚠️ {t('jealousyTest.ui.warningTypes')}
                </h3>
                <div className="space-y-1">
