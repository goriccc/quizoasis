              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-2">
                {resultCharacteristics
                  ...
                  .map((item, i) => (
                    <span
                      key={i}
                      className="inline-flex items-center rounded-full border border-purple-100 bg-gradient-to-r from-purple-50 to-pink-50 px-3 py-2 text-sm font-medium text-gray-800 shadow-sm"
                    >
                      {item}
                    </span>
                  ))}
