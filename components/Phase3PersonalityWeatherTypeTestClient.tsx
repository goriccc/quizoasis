...
import {
  ...
  Phase3PersonalityWeatherTypeResult,
  calculatePhase3PersonalityWeatherTypeResult,
...
interface Phase3PersonalityWeatherTypeTestClientProps {
  ...
  title: string;
  description: string;
  questions: Phase3PersonalityWeatherTypeQuestion[];
  results: Phase3PersonalityWeatherTypeResult[];
...
export default function Phase3PersonalityWeatherTypeTestClient({
  locale,
  slug,
  title,
  description,
  ...
  isLatestTest = false,
  badgeType = null,
}: Phase3PersonalityWeatherTypeTestClientProps) {
  // ✅ 템플릿 UI/UX 그대로 사용: namespace만 변경
  const t = useTranslations('phase3PersonalityWeatherTypeTest');
  ...
  const [result, setResult] = useState<Phase3PersonalityWeatherTypeResult | null>(null);
  const [showResult, setShowResult] = useState(false);
  const [shuffledQuestions, setShuffledQuestions] = useState<Phase3PersonalityWeatherTypeQuestion[]>([]);
...
// 질문 섞기 함수
  const shuffleQuestions = (questionList: Phase3PersonalityWeatherTypeQuestion[]) => {
  ...
  const handleAnswer = (score: number) => {
    ...
    if (currentQuestion < shuffledQuestions.length - 1) {
      ...
      const resultType = calculatePhase3PersonalityWeatherTypeResult(answersArray);
  ...
  if (showResult && result) {
    ...
    const resultPersonalityWeather =
      result.personalityWeather[locale as keyof typeof result.personalityWeather] || result.personalityWeather.ko;
    const resultWeatherKeywords =
      result.weatherKeywords[locale as keyof typeof result.weatherKeywords] || result.weatherKeywords.ko;
    const resultWeatherPersonTrait =
      result.weatherPersonTrait[locale as keyof typeof result.weatherPersonTrait] || result.weatherPersonTrait.ko;
    const resultWeatherWeakness =
      result.weatherWeakness[locale as keyof typeof result.weatherWeakness] || result.weatherWeakness.ko;
    const resultGoodMatchWeather =
      result.goodMatchWeather[locale as keyof typeof result.goodMatchWeather] || result.goodMatchWeather.ko;
    const resultClashWeather =
      result.clashWeather[locale as keyof typeof result.clashWeather] || result.clashWeather.ko;
    const resultWeatherMessage =
      result.weatherMessage[locale as keyof typeof result.weatherMessage] || result.weatherMessage.ko;
    const resultWeatherOneLiner =
      result.weatherOneLiner[locale as keyof typeof result.weatherOneLiner] || result.weatherOneLiner.ko;
          ...
          <div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-2 text-left">⛅ {t('ui.personalityWeather')}</h3>
                <p className="text-lg font-bold text-purple-600 text-center leading-snug">
                  {resultPersonalityWeather}
                </p>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-5">
                <h3 className="text-base font-bold text-gray-800 mb-4 text-left">📊 {t('ui.weatherKeywords')}</h3>
                <div className="flex flex-wrap justify-center gap-2">
                  {resultWeatherKeywords.split(/[·、，]/).map((part, index) => (
                    <span
                      key={index}
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-2 text-left">👤 {t('ui.weatherPersonTrait')}</h3>
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultWeatherPersonTrait}</p>
              </div>
            </div>

            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-2 text-left">⚠️ {t('ui.weatherWeakness')}</h3>
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultWeatherWeakness}</p>
              </div>
            </div>

            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-2 text-left">🌤️ {t('ui.weatherMessage')}</h3>
                <p className="text-sm text-gray-700 leading-relaxed text-center">&quot;{resultWeatherMessage}&quot;</p>
              </div>
            </div>

            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-2 text-left">✨ {t('ui.weatherOneLiner')}</h3>
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultWeatherOneLiner}</p>
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-3">💖 {t('ui.goodMatchWeather')}</h3>
                <p className="text-sm text-gray-700 leading-relaxed">{resultGoodMatchWeather}</p>
              </div>

              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-3">💔 {t('ui.clashWeather')}</h3>
                <p className="text-sm text-gray-700 leading-relaxed">{resultClashWeather}</p>
              </div>
            </div>
