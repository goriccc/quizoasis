...
import {
  Phase3RoomPersonalityAnalysisQuestion,
  Phase3RoomPersonalityAnalysisResult,
  calculatePhase3RoomPersonalityAnalysisResult,
...
interface Phase3RoomPersonalityAnalysisTestClientProps {
  ...
  title: string;
  description: string;
  questions: Phase3RoomPersonalityAnalysisQuestion[];
  results: Phase3RoomPersonalityAnalysisResult[];
...
export default function Phase3RoomPersonalityAnalysisTestClient({ 
  locale, 
  slug, 
  title, 
  description,
...
,
  isLatestTest = false,
  badgeType = null
}: Phase3RoomPersonalityAnalysisTestClientProps) {
  const t = useTranslations('phase3RoomPersonalityAnalysisTest');
  ...
  const [result, setResult] = useState<Phase3RoomPersonalityAnalysisResult | null>(null);
  const [showResult, setShowResult] = useState(false);
  const [shuffledQuestions, setShuffledQuestions] = useState<Phase3RoomPersonalityAnalysisQuestion[]>([]);
...
// 질문 섞기 함수
  const shuffleQuestions = (questionList: Phase3RoomPersonalityAnalysisQuestion[]) => {
  ...
  const handleAnswer = (score: number) => {
    ...
    if (currentQuestion < shuffledQuestions.length - 1) {
      ...
      // 결과 계산
      const resultType = calculatePhase3RoomPersonalityAnalysisResult(answersArray);
  ...
  if (showResult && result) {
    ...
    const resultPersonalityKeywords =
      result.personalityKeywords[locale as keyof typeof result.personalityKeywords] ||
      result.personalityKeywords.ko;
    const resultIdealRoomStyle =
      result.idealRoomStyle[locale as keyof typeof result.idealRoomStyle] || result.idealRoomStyle.ko;
    const resultDreamRoomColors =
      result.dreamRoomColors[locale as keyof typeof result.dreamRoomColors] || result.dreamRoomColors.ko;
    const resultKeyFurniture =
      result.keyFurniture[locale as keyof typeof result.keyFurniture] || result.keyFurniture.ko;
    const resultMustHaveItems =
      result.mustHaveItems[locale as keyof typeof result.mustHaveItems] || result.mustHaveItems.ko;
    const resultNeverPut = result.neverPut[locale as keyof typeof result.neverPut] || result.neverPut.ko;
    const resultDreamRoomQuote =
      result.dreamRoomQuote[locale as keyof typeof result.dreamRoomQuote] || result.dreamRoomQuote.ko;
          ...
          <div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-5">
                <h3 className="text-base font-bold text-gray-800 mb-4 text-left">
                  ⭐ {t('ui.personalityKeywords')}
                </h3>
                <div className="flex flex-wrap justify-center gap-2">
                  {resultPersonalityKeywords.split(/[,、，]/).map((part, index) => (
                    <span
                      key={index}
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                ...
                <p className="text-lg font-bold text-purple-600 text-center leading-snug">{resultIdealRoomStyle}</p>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                <h3 className="text-base font-bold text-gray-800 mb-2 text-left">
                  🎨 {t('ui.dreamRoomColors')}
                </h3>
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultDreamRoomColors}</p>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                ...
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultKeyFurniture}</p>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                ...
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultMustHaveItems}</p>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                ...
                <p className="text-sm text-gray-700 leading-relaxed text-center">{resultNeverPut}</p>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="bg-white rounded-xl shadow-lg p-4">
                ...
                <p className="text-sm text-gray-700 leading-relaxed text-center italic">{resultDreamRoomQuote}</p>
              </div>
            </div>
